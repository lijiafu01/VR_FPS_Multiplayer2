...
public class SKill2 : NetworkBehaviour, IBossSkill
{
    ...
    [SerializeField] private NetworkObject _spikePrefab;
    ...
    public void SpawnSpike()
    {
        ...
        for (int i = 1; i <= 30; i++)
        {
            ...
            Runner.Spawn(_spikePrefab, spawnPosition, Quaternion.identity);
            Runner.Spawn(_spikeVFX, spawnPosition, Quaternion.identity);
        }
    }
