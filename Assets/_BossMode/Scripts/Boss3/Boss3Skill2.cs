...
public class Boss3Skill2 : NetworkBehaviour, IBossSkill
{
    ...
    [SerializeField] private NetworkObject _TornadoPrefab;
    // Tên của kỹ năng
    public string SkillName => "Skill2";
    ...
    public void SpawnSpike()
    {
        ...
        for (int i = 1; i <= spawnNum; i++)
        {
            ...
            Runner.Spawn(_TornadoPrefab, spawnPosition, Quaternion.identity);
        }
    }
